...
keys_to_match = ['dc:identifier', 'hasContact.schema:email', 'schema:telephone', 'hasDescription.shortDescription.fr', 'hasTheme.rdfs:label.fr',
                 'isLocatedAt.schema:address.schema:addressLocality', 'isLocatedAt.schema:address.schema:postalCode',
                 'isLocatedAt.schema:address.schema:streetAddress', 'isLocatedAt.schema:address.hasAddressCity.isPartOfDepartment.rdfs:label.fr',
                 'isLocatedAt.schema:address.hasAddressCity.isPartOfDepartment.isPartOfRegion.rdfs:label.fr', 'isLocatedAt.schema:geo.schema:latitude',
                 'isLocatedAt.schema:geo.schema:longitude', 'isLocatedAt.schema:openingHoursSpecification.schema:validFrom',
                 'isLocatedAt.schema:openingHoursSpecification.schema:validThrough','offers.schema:priceSpecification.schema:maxPrice',
                 'offers.schema:priceSpecification.schema:minPrice','offers.schema:priceSpecificationschema:priceCurrency',
